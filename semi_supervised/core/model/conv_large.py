...
class ConvLargeCifar(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.conv1a = nn.Conv2d(3, 128, 3, padding=1, bias=False)
        self.bn1a = nn.BatchNorm2d(128)
        self.conv1b = nn.Conv2d(128, 128, 3, padding=1, bias=False)
        self.bn1b = nn.BatchNorm2d(128)
        self.conv1c = nn.Conv2d(128, 128, 3, padding=1, bias=False)
        self.bn1c = nn.BatchNorm2d(128)
        self.mp1 = nn.MaxPool2d(2, stride=2, padding=1)
        self.drop1 = nn.Dropout(0.5)

        self.conv2a = nn.Conv2d(128, 256, 3, padding=1, bias=False)
        self.bn2a = nn.BatchNorm2d(256)
        self.conv2b = nn.Conv2d(256, 256, 3, padding=1, bias=False)
        self.bn2b = nn.BatchNorm2d(256)
        self.conv2c = nn.Conv2d(256, 256, 3, padding=1, bias=False)
        self.bn2c = nn.BatchNorm2d(256)
        self.mp2 = nn.MaxPool2d(2, stride=2, padding=1)
        self.drop2 = nn.Dropout(0.5)

        self.conv3a = nn.Conv2d(256, 512, 3, padding=0, bias=False)
        self.bn3a = nn.BatchNorm2d(512)
        self.conv3b = nn.Conv2d(512, 256, 1, padding=0, bias=False)
        self.bn3b = nn.BatchNorm2d(256)
        self.conv3c = nn.Conv2d(256, 128, 1, padding=0, bias=False)
